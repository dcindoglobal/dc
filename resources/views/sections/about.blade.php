        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <h3 class="text-4xl md:text-5xl font-bold text-[#0A2540] mb-6 leading-tight">
                    Integrated Site Support & Operations Company
                </h3>

                <p class="text-base text-gray-600 mb-6 leading-relaxed">
                    We are an Integrated Site Support & Operations Company covering 
                    <strong>Facility Management (FM)</strong>, <strong>Logistics</strong>, and 
                    <strong>Execution Support</strong>, supporting end-to-end project needs with 
                    operational excellence and strategic execution.
                </p>

                <div class="space-y-4 mb-8">
                    @foreach([
                        'End-to-end site support across Facility Management, Logistics & Execution',
                        'Operational excellence with strategic project execution',
                        'Streamlined on-site operations for faster, efficient delivery',
                        'Trusted partner for complex infrastructure and project needs'
                    ] as $point)
                ...
                <a href="{{ route('about') }}" 
                   class="bg-[#0A2540] hover:bg-[#1E3A5F] text-white px-6 py-3 rounded-lg font-semibold inline-flex items-center transition-colors duration-300">
                    LEARN MORE ABOUT US
